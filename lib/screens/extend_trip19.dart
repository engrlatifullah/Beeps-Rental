...
class ExtendTrip19 extends StatefulWidget {
  const ExtendTrip19({Key? key}) : super(key: key);

  @override
  State<ExtendTrip19> createState() => _ExtendTrip19State();
}

class _ExtendTrip19State extends State<ExtendTrip19> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: ListView(
          children: [HeaderCard(onTap: opendrawer,),
            Padding(
